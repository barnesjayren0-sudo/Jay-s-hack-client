...
public class JayHackClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        moduleManager.register(new ComboHit());
        moduleManager.register(new SoftBlink());
        moduleManager.register(new TargetStrafe());
        moduleManager.register(new AutoWeb());
        moduleManager.register(new AntiFireball());
        moduleManager.register(new SwordBlock());
        ...
        moduleManager.register(new PearlTrajectory());
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (client.player.hurtTime > 0) {
                try { BaritoneCompat.pauseCombat(); } catch (Throwable ignored) {}
            }
    ...
    private void handleCommand(String message) {
        ...
        if (Waypoints.tryCommand(args)) return;
